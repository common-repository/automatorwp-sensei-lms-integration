...
class AutomatorWP_Sensei_LMS_Complete_Lesson extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a lesson', 'automatorwp-sensei-lms-integration' ),
            'select_option'     => __( 'User completes <strong>a lesson</strong>', 'automatorwp-sensei-lms-integration' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Lesson:', 'automatorwp-sensei-lms-integration' ),
                    'option_none_label' => __( 'any lesson', 'automatorwp-sensei-lms-integration' ),
                    'post_type' => 'lesson'
                ) ),
                'times' => automatorwp_utilities_times_option(),
            ),
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Lesson', 'automatorwp-sensei-lms-integration' ) ),
