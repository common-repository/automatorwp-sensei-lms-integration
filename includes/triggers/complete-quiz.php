...
class AutomatorWP_Sensei_LMS_Complete_Quiz extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User attempts a quiz', 'automatorwp-sensei-lms-integration' ),
            'select_option'     => __( 'User <strong>attempts</strong> a quiz', 'automatorwp-sensei-lms-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User attempts %1$s %2$s time(s)', 'automatorwp-sensei-lms-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User attempts %1$s', 'automatorwp-sensei-lms-integration' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Quiz:', 'automatorwp-sensei-lms-integration' ),
                    'option_none_label' => __( 'any quiz', 'automatorwp-sensei-lms-integration' ),
                    'post_type' => 'quiz'
                ) ),
                'times' => automatorwp_utilities_times_option(),
            ),
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Quiz', 'automatorwp-sensei-lms-integration' ) ),
