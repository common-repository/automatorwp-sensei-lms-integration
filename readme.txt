...
Tags: sensei, lms, automatorwp, automator, automation, course, lesson, quiz
...
Connect AutomatorWP with Sensei LMS
...
[Sensei LMS](https://wordpress.org/plugins/sensei-lms/ "Sensei LMS") is a full-featured WordPress LMS plugin that allows you to easily create and sell courses online.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with Sensei LMS adding new triggers and actions that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.
...
[Pro version](https://automatorwp.com/add-ons/sensei-lms/ "AutomatorWP - Sensei LMS") available that let's you expand the integration between AutomatorWP and Sensei LMS bringing you more ways to automatize your elearning website.
